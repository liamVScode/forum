...
public class PrefixAdController {
    ...
    public ApiResponse<List<PrefixDto>> getAllListPrefix(){
        ApiResponse<List<PrefixDto>> apiResponse = new ApiResponse<>();
        apiResponse.setResult(prefixService.getAllListPrefix());
        return apiResponse;
    }
